...
Channel.fromPath(params.v_germline_file, type: 'any').map{ file -> tuple(file.baseName, file) }.set{g_2_germlineFastaFile_g_98}
...
g_2_germlineFastaFile_g_98= g_2_germlineFastaFile_g_98.ifEmpty([""]) 


process change_names_fasta {

input:
 set val(name), file(v_ref) from g_2_germlineFastaFile_g_98

output:
 set val(name), file("new_V_novel_germline*")  into g_98_germlineFastaFile0_g_8, g_98_germlineFastaFile0_g_96, g_98_germlineFastaFile0_g92_22, g_98_germlineFastaFile0_g92_43, g_98_germlineFastaFile0_g92_47, g_98_germlineFastaFile0_g92_12
...
input:
 set val(db_name), file(germlineFile) from g_98_germlineFastaFile0_g_96
...
input:
 set val(db_name), file(germlineFile) from g_98_germlineFastaFile0_g92_22
...
input:
 ...
 set val(name1), file(v_germline_file) from g_98_germlineFastaFile0_g92_12
...
input:
 ...
 set val(v_germline_name), file(v_germline_file) from g_98_germlineFastaFile0_g_8
...
input:
 ...
 set val(name2), file(v_ref) from g_98_germlineFastaFile0_g92_43
...
input:
 ...
 set val(name4), file(v_ref) from g_98_germlineFastaFile0_g92_47
